...
**Intervewer**: How long did they say it would last?
...
**Interviewer**: No, no, they do everything quite okay - and as for my
...
**Interviewee**: Did he receive training on biogas?
...
**Interviewer**: Yeah, there was a timewhen we switched it on and it did
not produce gas. We tried to find the problem and fix it, but we
...
Interviewer: Yes, I can lead. But, I can only read Chichewa. So, the
...
**Interviewer**: Oh, what type of problems do they face?

**Interviewee**: Some have digester bag punctured, the fitting issues,
and leakages.

**Interviewer**: Can the bug get punctured? What can puncture it? Do you
mean people puncture it deliberately?

**Interviewee**: Accidentally, we have also seen problems associated
with connections, especially gas connector.

**Interviewer**: Which kind of digester? This group?

**Interviewee**: Not this types though, some other type?
...
**Interviewer**: I had two boys who did the digging.
...
**Interviewer**: I can only say thanks to them and that there is nothing
