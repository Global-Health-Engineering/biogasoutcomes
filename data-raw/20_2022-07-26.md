...
**Interviewer**: Our biggest expectation was concentrated on the end
...
**Interviewer**: You know it's a challenge to use and maintain
...
**Interviewee**: In your opinion, why does development aid fail in
...
**Interviewer**: Some work, some don\'t depending on how it was
...
**Interviewer**: No, our digester never worked even once. I think the
...
**Interviewer**: We don't know the donor on the communication level.
...
**Interviewer**: They were coming so they knew that they had failed.

**Interviewer**: Calling a shade a spade, why do you think caused this
digester and the whole project to fail.

**Interviewer**: It's hard for me to say why this thing failed. I would
...
**Interviewee**: How do you manage feedstock now?

**Interviewer**: Mostly, we use cow manure as fertilizer in our plots.
...
**Interviewer**: Yeah, looks like all the things are from Malawi.
...
**Interviewee**: We are remaining with two questions. What is your
opinion of biogas?

**Interviewer**: In general, I can say it's good. It's renewable energy.
It's user friendly. It produces strong fire and it's fast; and, it\'s
smoke free.

**Interviewee**: Our study is basically looking at biogas failures, and
...
**Interviewer**: Why? Maybe because it works well in hot weather so it's
